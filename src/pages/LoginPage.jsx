  ...
  const handleSignIn = () => {
    ...
    menuService.login(email, password).then((result) => {
      if (result.data.geriBildirimDto.kodu != 0) {
        ...
        menuService
          .uyeTahsilatOnKontrol(
            result.data.uyeId,
            result.data.ePosta,
            result.data.kullaniciId
          )
          .then((result) => {
            if (result.data.geriBildirimDto.kodu != 0) {
              toast.error(result.data.geriBildirimDto.aciklama);
      ...
      <div className="d-flex justify-content-center align-items-center vh-100">
        <div className="p-3 rounded-4 bg-white w-25 h-70">
          <form>
            <h3>Kıbrıs Hesap</h3>
            <h5>
              Hoş geldiniz e-posta ve parolanız ile güvenli giriş yapabilirsiniz
            </h5>
            ...
            <p>
              <a
                href="sifreGonder"
                className="link-underline-light d-flex justify-content-end"
              >
                Şifremi unuttum
              </a>
            </p>
            ...
            <p>
              <a href="yeniUye" className="link-underline-light btn btn-link">
                Hesap oluşturun
              </a>
            </p>
          </form>
